...
{
    LounasookDatabase database;

    ListView lounasookListView;
    ...
    {
        lounasookListView.ItemsSource = database.GetLounasook().OrderByDescending(t => t.Kuupaev).ToList();
    }
